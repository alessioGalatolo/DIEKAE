...
def main():
    ...
    model = LlamaForSequenceClassification.from_pretrained(
        "checkpoints/sft/llama2-sft-icr", device_map=device, torch_dtype=torch.bfloat16, label2id=ICRDataset.token_to_number, id2label=ICRDataset.number_to_token, num_labels=len(ICRDataset.token_to_number)
    )
